        ...
        <form class="form-control w-50" method="POST" action="../action.php">
            ...
            <?php
                if(isset($_GET['update'])){
                    echo "<center><p class='alert alert-success'>Password Changed Successfully</p></center>";
                }
                //error
                if(isset($_GET['failedLogin'])){
                    echo "<center><p class='alert alert-warning'>Username or Password Incorrect!</p></center>";
                }
            ?>
